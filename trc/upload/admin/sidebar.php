...
<ul class="sidebar-panel nav">
  ...
  <li><a href="<?php echo $admin_ip; ?>dashboard.php"><span class="icon color5"><i class="fa fa-home"></i></span>Dashboard</a></li>
  <li><a href="#"><span class="icon color7"><i class="fa fa-flask"></i></span>Customer<span class="caret"></span></a>
    <ul>
      <li><a href="<?php echo $admin_ip; ?>customer.php">Add Customer</a></li>
      <li><a href="<?php echo $admin_ip; ?>customerlist.php">List Customer</a></li>
    </ul>
  </li>
  <li><a href="typography.html"><span class="icon color12"><i class="fa fa-cogs"></i></span>Settings</a></li>
